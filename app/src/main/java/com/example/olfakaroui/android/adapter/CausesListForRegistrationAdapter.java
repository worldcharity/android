...
public class CausesListForRegistrationAdapter extends BaseAdapter {
    ...
    public CausesListForRegistrationAdapter(Context aContext, List<Cause> listData) {
    ...
    public View getView(final int position,  View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.cause_reg_item, null);
